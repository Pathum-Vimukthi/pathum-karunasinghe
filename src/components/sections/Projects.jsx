        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              Developing an Inventory Management System, including a responsive
              and interactive user interface using React.js and Flowbite UI
              components. The backend was built using Node.js and Express.js to
              implement strong server-side logic and APIs.
            </p>
          ...
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
            ...
            <p className="text-gray-400 mb-4">
              Developed a Desktop Application using OOP Concepts, Java, JavaFX,
              MySQL with SceneBuilder and IntelliJ IDEA as a part of Java
              Programming module in the second year.
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
